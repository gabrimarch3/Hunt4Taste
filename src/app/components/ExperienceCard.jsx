    ...
    <div className="max-w-full h-[300px] rounded-3xl overflow-hidden shadow-lg my-2">
      <div className="relative w-full h-48">
        ...
        />
          ...
          <button className="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded-full absolute bottom-1.5 right-5 transform translate-y-1/2 group-hover:translate-y-0 transition-all duration-300">
            {buttonText}
          </button>
      </div>
